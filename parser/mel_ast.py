...
class LiteralNode(ExprNode):
    ...
    def semantic_check(self, scope: IdentScope) -> None:
        if isinstance(self.value, bool):
            ...
            self.semantic_error('Unknown/incorrect type ' + type(self.value) + ' of variable self.value')
...
class IdentNode(ExprNode):
    ...
    def semantic_check(self, scope: IdentScope) -> None:
        ...
        if ident is None:
            self.semantic_error('Identifier ' + self.name + ' does not found/exist')
...
class TypeNode(IdentNode):
    ...
    def semantic_check(self, scope: IdentScope) -> None:
        if self.type is None:
            self.semantic_error('Unknown/incorrect type ' + self.name)
...
class VarNode(StmtNode):
    ...
    def semantic_check(self, scope: IdentScope) -> None:
        ...
        self.var = type_convert(self.var, self.type.type if self.type is not None else None, self,
